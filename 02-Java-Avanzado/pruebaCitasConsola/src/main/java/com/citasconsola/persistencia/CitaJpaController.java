...
package com.citasconsola.persistencia;

import com.citasconsola.logica.Cita;
import com.citasconsola.persistencia.exceptions.NonexistentEntityException;
...
public class CitaJpaController implements Serializable {
    ...
    public CitaJpaController(){
        this.emf =Persistence.createEntityManagerFactory("citaspruebaPU");
    }
